...
public class GestionBD extends SQLiteOpenHelper {
    ...
    private static final String CREARTABLA = "CREATE TABLE " + TUSUARIOS +" (USU_DOCUMENTO INTEGER PRIMARY KEY, USU_USUARIO varchar(40) NOT NULL, USU_NOMBRES varchar(40) NOT NULL, USU_APELLLIDOS varchar(40) NOT NULL, USU_CONTRA varchar(25) NOT NULL )";
